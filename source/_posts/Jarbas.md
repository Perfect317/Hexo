...
![](images/image-20240822171327597.png)

这里 awk 命令的意思是，以 **/** 为分界线，打印第一列

![image-20240822173542069](images/image-20240822173542069.png)

再进行变量指定

![image-20240822174048570](images/image-20240822174048570.png)

此时打印ports就是打印这四个端口

![image-20240822174114467](images/image-20240822174114467.png)
...
![image-20240822174303564](images/image-20240822174303564.png)

再扫描UDP端口，显示全部关闭

![image-20240822175013842](images/image-20240822175013842.png)

## 3.漏洞扫描

使用nmap自带的漏扫工具进行漏洞扫描，-script=vuln参数

![image-20240822175554396](images/image-20240822175554396.png)

漏洞扫描显示有潜在的目录列表，扫目录试试，这里是使用dirsearch扫目录的，发现个html页面，尝试打开

还发现一个robots.txt文件

![image-20240822175835381](images/image-20240822175835381.png)

直接访问靶机ip也可以打开一个网页，暂时没有思路，先跳过（此时默认端口是80）

![image-20240822175950829](images/image-20240822175950829.png)

访问192.168.204.132/access.html页面，这是三段加密的字符串，先尝试进行破解

![image-20240822180027350](images/image-20240822180027350.png)

使用hash-identifier识别加密算法，发现是MD5

![hash-identifier](images/image-20240822181643200.png)

![hash-identifier](images/image-20240822181757826.png)

![hash-identifier](images/image-20240822181816169.png)
...
![MD5](images/image-20240822181918037.png)tiago:italia99

![MD5](images/image-20240822181959287.png)

trindade:marianna

![MD5](images/image-20240822182023268.png)

eder:vipsu

访问192.168.204.132/Robots.txt发现无法访问

![Robots.txt](images/image-20240822180902208.png)

此时默认的是80端口，但还开放了8080端口，此时就应该想到使用8080端口访问

![image-20240822181114067](images/image-20240822181114067.png)

访问192.168.204.132:8080，发现登录页面

![image-20240822181231431](images/image-20240822181231431.png)

猜测上面/access.html页面冒号前面的为用户名，后面的为密码，尝试使用破解的密码登录,前两个不行，最后一个成功登录

![jenkins](images/image-20240822182708291.png)

成功登录到该cms后台页面，创建一个新任务

![image-20240822204558662](images/image-20240822204558662.png)

发现下面有命令执行，进行shell反弹

![image-20240822204832840](images/image-20240822204832840.png)

先进行监听，然后再构建任务

![image-20240822204906020](images/image-20240822204906020.png)
